    ...
    >
      ...
      >
        <motion.div
          ...
          className="glass-card rounded-2xl p-8 border-t-4 border-t-[var(--primary)] bg-gradient-to-br from-[var(--primary)]/12 via-transparent to-transparent"
        >
          ...
          <ul className="mt-6 space-y-3">
            {smeValueProps.map((item) => (
              <li key={item} className="flex items-start gap-3 text-[var(--foreground)]/85">
                <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[var(--primary)]/20 text-[var(--primary)] text-xs">
                  ✓
                </span>
                {item}
              </li>
        ...
        <motion.div
          variants={staggerItem}
          className="glass-card rounded-2xl p-8 border-t-4 border-t-[var(--muted-green)] bg-gradient-to-bl from-[var(--muted-green)]/14 via-transparent to-transparent"
        >
          ...
          <ul className="mt-6 space-y-3">
            {bankValueProps.map((item) => (
              <li key={item} className="flex items-start gap-3 text-[var(--foreground)]/85">
                <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[var(--muted-green)]/18 text-[var(--muted-green)] text-xs">
                  ✓
                </span>
                {item}
              </li>
